...
treeSize :: Tree a -> Int
treeSize Empty = 0
treeSize (Node _ l r) = treeSize l + 1 + treeSize r
...
set [] v (Node _ l r) = Node v l r
set (StepL : xs) v (Node a l r) = Node a (set xs v l) r
set (StepR : xs) v (Node a l r) = Node a l (set xs v r)
set _ _ t = t
